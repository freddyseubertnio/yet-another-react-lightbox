...
type LightboxExternalProps = DeepPartial<
  DeepPartial<
    DeepPartial<LightboxProps, "animation" | "customAnimation" | "toolbar" | "noScroll">,
    "carousel",
    "imageProps"
  >,
  "controller",
...
type DeepPartialValue<T, E extends string = never> = T extends any[]
  ? T
